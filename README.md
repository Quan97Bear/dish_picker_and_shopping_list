...
一个无登录、无后端、手机优先的家常菜单选择与采购清单静态应用。当前部署携带固定的 40 道简单家常菜，其中恰好 5 道汤，不含茄子。选菜者可按青椒/尖椒、鱼、猪肉、鸡蛋和辣味设置忌口筛选。
...
应用不收集个人信息，不包含分析或广告。分享 URL 只保存菜品 ID、人数和协议版本；持有链接的人都能看到对应菜单。
